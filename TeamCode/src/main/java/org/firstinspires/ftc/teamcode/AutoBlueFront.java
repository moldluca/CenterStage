...
@Autonomous(name="AutoBlueFront", group="chad")
public class AutoBlueFront extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        waitForStartify();
        //
        strafeToPosition(3.2, 0.2);
        //
        moveToPosition(26.8, 0.5);
        //
        moveToPosition(-1.6, 0.5);
        //
        strafeToPosition(-75.6, 0.5);
        //
        turnWithGyro(90, 0.5);
        //
        strafeToPosition(24.6, 0.5);
        //
        moveToPosition(-19, 0.5);
        //
    }
    //
    /*
